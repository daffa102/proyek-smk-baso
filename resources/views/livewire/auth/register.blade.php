<div class="bg-slate-50 min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
    <!DOCTYPE html>
    <html lang="id">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="glass-card p-8 md:p-10 rounded-[2.5rem] shadow-2xl shadow-blue-200/50">
                <form class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label for="nama" class="text-sm font-bold text-slate-700 ml-1">Nama</label>
                        <div class="relative">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="email" id="email" placeholder="contoh@sekolah.id"
                                class="w-full px-5 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all placeholder:text-slate-300 font-medium">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" id="nip" placeholder="123456789"
                                class="w-full px-5 py-4 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all placeholder:text-slate-300 font-medium">
                        </div>
                    </div>
