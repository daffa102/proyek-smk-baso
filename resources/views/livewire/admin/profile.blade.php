            ...
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8">
                ...
                @if ($showPasswordForm)
                    <form wire:submit.prevent="updatePassword" class="space-y-5">
                        ...
                        <!-- New Password -->
                        <div>
                            <label class="block text-xs font-black text-slate-400 uppercase mb-2">Password Baru</label>
                        ...
                        <div>
                            <label class="block text-xs font-black text-slate-400 uppercase mb-2">Konfirmasi Password
                                Baru</label>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-sm font-bold text-slate-400">Klik tombol "Ubah Password" untuk mengubah password
                            Anda</p>
                    </div>
                @endif
            </div>
