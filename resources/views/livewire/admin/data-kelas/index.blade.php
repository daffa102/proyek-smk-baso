<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="mb-6">
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Data Kelas</h1>
            <p class="text-slate-500 font-bold mt-1">Manajemen data kelas dan rombel.</p>
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th class="px-8 py-5 text-xs font-black text-slate-400 uppercase">Nama Kelas</th>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-slate-900">{{ $kelas->nama_kelas }}</p>
                                        <p class="text-[11px] font-bold text-slate-400 uppercase tracking-tighter">ID:
                                            {{ str_pad($kelas->id, 4, '0', STR_PAD_LEFT) }}</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-5 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button wire:click="delete({{ $kelas->id }})"
                                        wire:confirm="Apakah Anda yakin ingin menghapus data kelas ini?"
                        ...
                        <tr>
                            <td colspan="3" class="px-8 py-10 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-slate-500 font-bold">Tidak ada data kelas ditemukan.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
