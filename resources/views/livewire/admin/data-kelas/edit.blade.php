<div>
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Edit Data Kelas</h1>
        <p class="text-slate-500 font-bold mt-1">Perbarui informasi data kelas di bawah ini.</p>
    </div>
