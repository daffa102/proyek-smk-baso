<div>
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Tambah Kelas Baru</h1>
        <p class="text-slate-500 font-bold mt-1">Lengkapi formulir di bawah ini untuk menambahkan data kelas baru.</p>
    </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden max-w-2xl">
        <form wire:submit.prevent="save" class="p-8 md:p-12">
            <div class="space-y-6">
                <!-- Nama Kelas -->
                <div class="space-y-2">
                    <label for="nama_kelas" class="text-sm font-black text-slate-700 uppercase tracking-wider">Nama
                        Kelas</label>
                    <div class="relative">
                        ...
                        <input wire:model="nama_kelas" type="text" id="nama_kelas"
                            class="block w-full pl-11 pr-4 py-4 bg-slate-50 border-2 border-transparent rounded-2xl text-sm font-bold placeholder:text-slate-400 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all @error('nama_kelas') border-red-500 focus:border-red-500 focus:ring-red-500/10 @enderror"
