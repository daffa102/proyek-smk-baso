<div>
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Edit Data Guru</h1>
        <p class="text-slate-500 font-bold mt-1">Perbarui informasi data guru di bawah ini.</p>
    </div>
                ...
                <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-50">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            <label for="password"
                                class="text-sm font-black text-slate-700 uppercase tracking-wider">Password
                                Baru</label>
                            <span
                                class="text-[10px] font-black text-blue-500 uppercase tracking-widest bg-blue-50 px-2 py-0.5 rounded-md">Opsional</span>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
