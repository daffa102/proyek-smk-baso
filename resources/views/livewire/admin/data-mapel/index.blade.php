<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="mb-6">
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Data Mata Pelajaran</h1>
            <p class="text-slate-500 font-bold mt-1">Manajemen daftar mata pelajaran sekolah.</p>
        </div>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-8 py-5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-slate-900">{{ $mapel->nama_mapel }}</p>
