<div>
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-black text-slate-900 tracking-tight">Tambah Mata Pelajaran</h1>
        <p class="text-slate-500 font-bold mt-1">Lengkapi formulir di bawah ini untuk menambahkan mata pelajaran baru.
        </p>
    </div>
