<div class="flex min-h-screen">
        ...
        <aside class="w-72 fixed inset-y-0 left-0 glass-sidebar z-50 hidden lg:flex flex-col p-6">
            ...
            <nav class="flex-1 space-y-2">
                ...
                <a href="#" class="sidebar-item-active flex items-center gap-3 px-4 py-3.5 rounded-2xl font-bold transition-all group">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3.5 rounded-2xl font-bold text-slate-500 hover:bg-slate-100 hover:text-slate-900 transition-all">
            ...
            <div class="mt-auto pt-6 border-t border-slate-100">
                <div class="flex items-center gap-3 p-2">
                    ...
                    <div class="flex-1 overflow-hidden">
                        <p class="text-sm font-black text-slate-900 truncate">Admin Sekolah</p>
                        <p class="text-xs font-bold text-slate-400 truncate">admin@sekolah.id</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
                    <div class="w-14 h-14 bg-amber-100 text-amber-600 rounded-2xl flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9Z"/><path d="M3 9V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v4"/></svg>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
                    <div class="w-14 h-14 bg-green-100 text-green-600 rounded-2xl flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21a8 8 0 0 0-16 0"/><circle cx="12" cy="8" r="5"/></svg>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex items-center gap-5">
                    <div class="w-14 h-14 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/></svg>
                    </div>
                    <div>
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 font-bold text-sm">AR</div>
                                        <div>
                                            <p class="text-sm font-bold text-slate-900">Dummy</p>
                                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-tighter">ID: 2025001</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-8 py-5">
                                    <span class="inline-flex px-3 py-1 rounded-full bg-green-100 text-green-600 text-[11px] font-black uppercase">Hadir</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <button class="text-slate-400 hover:text-blue-600 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg></button>
                                </td>
                            </tr>
                            <!-- Row 2 -->
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 font-bold text-sm">SP</div>
                                        <div>
                                            <p class="text-sm font-bold text-slate-900">Dummy</p>
                                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-tighter">ID: 2025002</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-8 py-5">
                                    <span class="inline-flex px-3 py-1 rounded-full bg-amber-100 text-amber-600 text-[11px] font-black uppercase">Izin</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <button class="text-slate-400 hover:text-blue-600 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg></button>
                                </td>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                <td class="px-8 py-5">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 bg-red-100 rounded-lg flex items-center justify-center text-red-600 font-bold text-sm">BM</div>
                                        <div>
                                            <p class="text-sm font-bold text-slate-900">Dummy</p>
                                            <p class="text-[11px] font-bold text-slate-400 uppercase tracking-tighter">ID: 2025003</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-8 py-5">
                                    <span class="inline-flex px-3 py-1 rounded-full bg-red-100 text-red-600 text-[11px] font-black uppercase">Alpa</span>
                                </td>
                                <td class="px-8 py-5 text-center">
                                    <button class="text-slate-400 hover:text-blue-600 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg></button>
                                </td>
